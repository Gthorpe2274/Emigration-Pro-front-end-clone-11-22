...
const VIDEOS = [
  {
    id: 'clQDpweh-yc',
    title: 'The Complete Guide to Marketing Your Book on Amazon KDP',
  },
  {
    id: 'GR9HDK2yFlc',
    title: 'The NEW Way to Make a Full-Time Income with Amazon KDP in 2026',
  },
  {
    id: 'iYdwnIak7Sg',
    title: 'A Once in a Lifetime KDP Opportunity is Here (Won’t Happen Again)',
  },
  {
    id: 'BE6Ygtc8Sk0',
    title: '5 eBook Niches With INSANE Demand But Low Competition',
  },
  {
    id: 'Tfou5kmqD8k',
    title: 'NEW TikTok Strategy Scaled His Amazon KDP Business to $50k/mo',
  },
  {
    id: 'UCSl55tNyUE',
    title: 'BRUTAL Amazon KDP Advice You NEED But Don’t Want to Hear',
  },
  {
    id: 'BRurSZW8w3g',
...
export default function DigitalSales() {
  useSEO({
    title: PAGE_SEO['/digital-sales'].title,
    description: PAGE_SEO['/digital-sales'].description,
    canonicalPath: '/digital-sales',
  });
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {VIDEOS.map((video) => (
              ...
              >
                ...
                <h3 className="font-brand-serif text-xl font-medium text-brand-ink px-2">
                  {video.title}
                </h3>
              </div>
            ))}
