      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center bg-purple-100 text-purple-800 px-4 py-2 rounded-full text-sm font-medium mb-4">
            ...
            Document Retrieval System Dashboard
          </div>
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            System Monitoring
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Monitor the health and performance of the document retrieval system for enhanced emigration research.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-gray-800 mb-3">Document Retrieval System</h4>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>• Advanced retrieval for high accuracy</li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li>• External Python retrieval microservice</li>
                <li>• Advanced answer generation pipeline</li>
