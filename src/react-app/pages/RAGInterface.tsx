      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            knowledge base with real-time document retrieval.
          </p>
        </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                ...
                {results.fallback && (
                  <p className="text-sm text-red-600 mt-2">
                    The document retrieval service may not be configured or available. 
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <div className="flex items-center">
                  ...
                  <span className="text-green-800">
                    Search completed successfully using advanced document retrieval
                  </span>
                </div>
              </div>
            )}
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-gray-600 text-sm mb-3">
                Get comprehensive answers based on verified sources. 
                Perfect for complex questions requiring detailed explanations.
              </p>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• Combines document retrieval with analysis</li>
