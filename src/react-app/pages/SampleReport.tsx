    ...
    <div className="bg-gray-100 text-gray-800">
      ...
      <div className="container mx-auto p-6 md:p-12 lg:p-16 bg-white shadow-lg min-h-screen">
        <style>{`
            ...
            .redacted-cell {
                background-color: #333; /* Dark background to simulate redaction */
                min-height: 2.5rem; /* Ensure some height for visibility */
                display: flex;
                align-items: center;
                justify-content: center;
                color: #ccc; /* Placeholder text color */
            }
            /* Styling for the financial grid headers */
            ...
            /* Styling for main categories in the financial grid */
            ...
            /* Styling for individual items in the financial grid */
            .financial-grid-item {
                padding: 0.75rem; /* p-3 */
                padding-left: 1.5rem; /* pl-6 to simulate indentation */
                border-bottom: 1px solid #d1d5db; /* border-gray-300 */
                border-right: 1px solid #d1d5db; /* border-gray-300 */
            }
            /* Styling for the redacted value cells, ensuring consistent borders */
            .financial-grid-redacted-value {
                 border-bottom: 1px solid #d1d5db; /* border-gray-300 */
                 border-right: 1px solid #d1d5db; /* border-gray-300 */
            }
            /* Remove specific borders for the very last item row to complete the table look */
