...
export default function Youtuber() {
  useSEO({
    title: PAGE_SEO['/youtuber'].title,
    description: PAGE_SEO['/youtuber'].description,
    canonicalPath: '/youtuber',
  });
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8 py-16 md:py-24">
          ...
          {VIDEOS.length === 0 ? (
            <div className="bg-brand-bg p-8 rounded-xl border border-brand-border shadow-sm">
              <p className="text-sm leading-relaxed text-brand-muted">Resources for this category are coming soon.</p>
            </div>
          ) : (
